...
namespace BalancedTournamentArmor
{
    public class BalancedTournamentArmorSettings : AttributeGlobalSettings<BalancedTournamentArmorSettings>
    {
        ...
        [SettingPropertyBool("Heal Heroes to Full HP", Order = 0, RequireRestart = false, HintText = "Heal nobles and companions to full HP. HP will revert after the tournament. Enabled by default.")]
